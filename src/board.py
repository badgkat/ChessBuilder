...
PURPLE = (160, 32, 240)  # purchase placement squares
CHECK_HIGHLIGHT_COLOR = (255, 50, 50, 100)  # semi-transparent red for king in check
LAST_MOVE_COLOR = (186, 202, 68, 90)  # semi-transparent yellow-green for last move
...
PIECE_COST = {"P": 1, "N": 3, "B": 3, "R": 5, "Q": 9}
...
def get_valid_moves(piece, pos, board, en_passant=None):
    ...
    if piece.type == "K":
        ...
        if in_bounds(nr, c) and board[nr][c] is None:
            ...
            if (piece.color == "white" and r == 6) or (
                piece.color == "black" and r == 1
            ):
                nr2 = r + 2 * direction
    ...
    if piece.type == "K":
        for dr, dc in KING_MOVES:
            ...
            if (
                ...
                and board[nr][nc].color == piece.color
            ):
